...
export default function SocietyPage() {
  ...
  if (!gameState) {
    return <div className="text-gold text-center py-10 animate-pulse">Die Gesellschaft erwacht…</div>;
  }
  if (!isOfflineMode) {
    return (
      <div className="text-parchment/70 text-sm max-w-lg mx-auto py-10">
        Gesellschaftssysteme sind im Offline-Browser-Modus vollständig spielbar.
      </div>
    );
  }

  return <SocietyView gameState={gameState} onUpdate={setGameState} />;
}
